...
import { redactPaymentFields } from "@/lib/server/bookingService";
import type { Booking } from "@/lib/types";

/**
 * Requirement #7: employees must never see payment information. This is a
 * regression guard on the exact function GET /api/bookings uses to redact a
 * paid booking before it ever reaches a non-manager session.
 */
