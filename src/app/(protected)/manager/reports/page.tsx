...
export default function ReportsPage() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- show the spinner immediately when the date range changes
    setLoading(true);
    const q = query(
  ...
  }, [bookings, workerId, areaId, shift, paidFilter, paymentMethod]);
